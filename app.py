...
Ο μετρητής κατέγραψε συνολικά **{total_kwh} kWh**, αλλά η ΔΕΗ σας τιμολόγησε μόνο για τις **{billed_kwh:.1f} kWh**.  
Αυτό σημαίνει ότι **{hidden_kwh:.1f} kWh** δεν εμφανίστηκαν ποτέ στο λογαριασμό – είναι η ενέργεια που κάλυψε το φωτοβολταϊκό σας.

**2. Ανάλυση του κέρδους ανά κατηγορία:**  
- Αξία ενέργειας (στη μέση τιμή {avg_rate_no_vat:.3f} €/kWh): **{saved_energy:.2f} €**  
- Ρυθμιζόμενες χρεώσεις (ΑΔΜΗΕ+ΔΕΔΔΗΕ+ΥΚΩ+ΕΤΜΕΑΡ): **{saved_regulated:.2f} €**  
- ΕΦΚ: **{saved_efk:.2f} €**  
- Ειδικό τέλος 5‰: **{saved_eidiko_telos:.2f} €**  
- ΦΠΑ 6%: **{saved_vat:.2f} €**

**3. Συνολικό καθαρό όφελος:** **{total_saved:.2f} €** (δηλαδή τόσα λιγότερα πληρώσατε χάρη στο φωτοβολταϊκό)
                    """)
                    
            else:
                st.error("Δεν ήταν δυνατή η ανάγνωση των απαραίτητων στοιχείων από το PDF. Βεβαιωθείτε ότι ο λογαριασμός είναι εκκαθαριστικός της ΔΕΗ.")
